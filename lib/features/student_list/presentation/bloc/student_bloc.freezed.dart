...
mixin _$StudentEvent {
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>({
    required TResult Function(LoadStudents value) loadStudents,
    required TResult Function(AddStudent value) addStudent,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(LoadStudents value)? loadStudents,
...
class _$LoadStudentsImpl implements LoadStudents {
...
abstract class LoadStudents implements StudentEvent {
  const factory LoadStudents(final String grade) = _$LoadStudentsImpl;
...
class _$AddStudentImpl implements AddStudent {
...
abstract class AddStudent implements StudentEvent {
  const factory AddStudent(final Student student) = _$AddStudentImpl;
